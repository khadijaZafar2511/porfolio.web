      ...
      <div className="w-full min-h-screen  bg-gradient-to-tl from-white-500 via-[rgb(192,149,239)] to-[rgb(192,149,239)] ">
        <div className="w-full h-[100dvh]  flex flex-col  md:flex-row ">
          <div className="  md:h-[100dvh] md:w-1/2  w-full h-1/2 flex flex-col  items-center justify-center ">
            ...
            <div className=" md:h-[10dvh] h-[10dvh] w-full text-white  grid grid-cols-3 gap-1 px-12 ">
              <dv className=" flex justify-center items-center border border-white border-solid border-1 bg-[rgb(172,129,239)]">
                experience
              </dv>
              <div className=" flex justify-center items-center border border-white border-solid border-1 bg-[rgb(172,129,239)]">
                project
              </div>
          ...
          <div className=" md:h-[100dvh] md:w-1/2 w-full h-1/2 flex items-center md:justify-start justify-center">
