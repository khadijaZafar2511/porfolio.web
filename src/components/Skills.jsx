        ...
        <div className="w-full h-screen  bg-gradient-to-tl from-white-500 via-[rgb(192,149,239)] to-[rgb(192,149,239)] flex items-center justify-center">
          <div className="w-3/4 h-5/6 bg-purple-300 flex flex-col items-center border border-none rounded-2xl  shadow-2xl shadow-purple-400 ">
            <div className="w-full h-[25dvh] bg-[rgb(122,96,160,1)] border border-none rounded-2xl flex flex-col items-center  text-gray-200 ">
              <h1 className=" md:text-3xl md:font-bold  text-2xl font-semibold md:mt-3">
                What I do
              </h1>
              <p className="md:text-base md:font-base  text-[12px] font-base">
            ...
            <div className=" md:w-3/4 w-full h-5/6  md:text-lg text-[11px]  text-purple-500 font-semibold  shadow-2xl shadow-purple-400">
              <div className="w-full h-1/2 grid md:grid-cols-4 grid-cols-2 md:gap-12 gap-2  md:px-20 md:py-6 py-2 px-7 ">
                <div className=" transition duration-300 hover:scale-110 hover:shadow-xl border rounded-2xl md:rounded-4xl border-none shadow-2xl shadow-purple-400 bg-purple-300 flex items-center justify-center flex-col">
                  <img
                ...
                <div className=" transition duration-300  hover:shadow-xl  hover:scale-110 border   rounded-2xl md:rounded-4xl border-none shadow-2xl shadow-purple-400 bg-purple-300 flex items-center justify-center flex-col">
                  <img
